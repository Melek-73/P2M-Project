/**
  ...
  ******************************************************************************
  */
#ifndef AI_HGR_MODEL_H
#define AI_HGR_MODEL_H

#include "hgr_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_HGR_MODEL_MODEL_NAME          "hgr_model"
#define AI_HGR_MODEL_ORIGIN_MODEL_NAME   "stm32_gesture_model"

/******************************************************************************/
#define AI_HGR_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_HGR_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_HGR_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_HGR_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_HGR_MODEL_IN \
  ai_hgr_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_HGR_MODEL_IN_SIZE { \
  AI_HGR_MODEL_IN_1_SIZE, \
}
#define AI_HGR_MODEL_IN_SIZE_BYTES { \
  AI_HGR_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_HGR_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_HGR_MODEL_IN_1_HEIGHT      (64)
#define AI_HGR_MODEL_IN_1_WIDTH       (64)
#define AI_HGR_MODEL_IN_1_CHANNEL     (1)
#define AI_HGR_MODEL_IN_1_SIZE        (4096)
#define AI_HGR_MODEL_IN_1_SIZE_BYTES  (4096)

/******************************************************************************/
#define AI_HGR_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_HGR_MODEL_OUT \
  ai_hgr_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_HGR_MODEL_OUT_SIZE { \
  AI_HGR_MODEL_OUT_1_SIZE, \
}
#define AI_HGR_MODEL_OUT_SIZE_BYTES { \
  AI_HGR_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_HGR_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_HGR_MODEL_OUT_1_CHANNEL     (10)
#define AI_HGR_MODEL_OUT_1_SIZE        (10)
#define AI_HGR_MODEL_OUT_1_SIZE_BYTES  (10)

/******************************************************************************/
#define AI_HGR_MODEL_N_NODES (7)
 ...
 * @ref ai_hgr_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_hgr_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_hgr_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_hgr_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_HGR_MODEL_*
 * defines into file @ref hgr_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_hgr_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_HGR_MODEL_H */
